...
/*   Updated: 2026/01/19 13:52:19 by jguacide      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void			draw_textured_line(int row, t_ray *ray, t_textures *tex,
					t_img *frame);
...
void			my_mlx_create_image(void *mlx, t_img *img, int width,
					int height);
